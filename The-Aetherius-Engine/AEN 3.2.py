...
class Visualizer(tk.Tk):
    def __init__(self, kernel: AetheriusKernel):
        ...
        self.after(5000, self.end_splash) # 5s Splash duration
    ...
    def draw_splash(self):
        ...
        # Title
        self.canvas.create_text(cx, cy - 80, text="THE AETHERIUS ENGINE", fill="#00ff9d", font=("Courier", 24, "bold"))
        
        # Subtitle
        self.canvas.create_text(cx, cy - 40, text="Quantum-Probabilistic Neuromorphic Simulator", fill="#00bcd4", font=("Consolas", 12))
        
        # Divider
        self.canvas.create_line(cx - 150, cy, cx + 150, cy, fill="#333", width=2)
        
        # Info
        self.canvas.create_text(cx, cy + 40, text="ARCHITECT: INITIATED BY USER", fill="#555", font=("Consolas", 10))
        self.canvas.create_text(cx, cy + 60, text="PURPOSE: Simulating Hilbert Space Topologies", fill="#555", font=("Consolas", 10))
        ...
        self.canvas.create_rectangle(bx, by, bx + bar_w, by + bar_h, outline="#333", fill="")
        self.canvas.create_rectangle(bx, by, bx + (bar_w * progress), by + bar_h, fill="#00ff9d", outline="")
        
        self.canvas.create_text(cx, by + 20, text=f"INITIALIZING KERNEL... {int(progress*100)}%", fill="#00ff9d", font=("Consolas", 8))

        # Creator Credit
        self.canvas.create_text(w - 20, h - 20, text="Creator: Hemendra_TheAegis", fill="#444444", font=("Consolas", 10, "bold"), anchor="se")
